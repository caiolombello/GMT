                ...
                json.dump(
                    {
                        ...
                        "allow_merge_on_skipped_pipeline": resp_dict[i][
                            "allow_merge_on_skipped_pipeline"
                        ],
                        "analytics_access_level": resp_dict[i][
                            "analytics_access_level"
                        ],
                        "auto_cancel_pending_pipelines": resp_dict[i][
                            "auto_cancel_pending_pipelines"
                        ],
                        "auto_devops_deploy_strategy": resp_dict[i][
                            "auto_devops_deploy_strategy"
                        ],
                        "auto_devops_enabled": resp_dict[i]["auto_devops_enabled"],
                        "autoclose_referenced_issues": resp_dict[i][
                        ...
                        "container_registry_access_level": resp_dict[i][
                            "container_registry_access_level"
                        ],
                        "container_registry_enabled": resp_dict[i][
                        ...
                        "external_authorization_classification_label": resp_dict[i][
                        ...
                        "merge_requests_access_level": resp_dict[i][
                            "merge_requests_access_level"
                        ],
                        "merge_requests_enabled": resp_dict[i][
                            "merge_requests_enabled"
                        ],
                        "only_allow_merge_if_all_discussions_are_resolved": resp_dict[
                            i
                        ]["only_allow_merge_if_all_discussions_are_resolved"],
                        "only_allow_merge_if_pipeline_succeeds": resp_dict[i][
                            "only_allow_merge_if_pipeline_succeeds"
                        ],
                        "operations_access_level": resp_dict[i][
                            "operations_access_level"
                        ],
                        "packages_enabled": resp_dict[i]["packages_enabled"],
                        "pages_access_level": resp_dict[i]["pages_access_level"],
                        "printing_merge_request_link_enabled": resp_dict[i][
                            "printing_merge_request_link_enabled"
                        ],
                        "remove_source_branch_after_merge": resp_dict[i][
                            "remove_source_branch_after_merge"
                        ],
                        "repository_access_level": resp_dict[i][
                            "repository_access_level"
                        ],
                        "request_access_enabled": resp_dict[i][
                            "request_access_enabled"
                        ],
                        "requirements_access_level": resp_dict[i][
                            "requirements_access_level"
                        ],
                        "resolve_outdated_diff_discussions": resp_dict[i][
                            "resolve_outdated_diff_discussions"
                        ],
                        "security_and_compliance_access_level": resp_dict[i][
                            "security_and_compliance_access_level"
                        ],
                        "shared_runners_enabled": resp_dict[i][
